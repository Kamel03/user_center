...
public class OrganizationServiceHelper {
	...
	public static Organization getRootOrg(
			OrganizationService organizationService) {
		return organizationService.findOrganizationsByParentId(null)
				.get(0);
	}
